...
// Import multiple background images (you can replace or add more later)
import img1 from "../../assets/homemain.png";
import img2 from "../../assets/ProjectViewMain1.png";
import img3 from "../../assets/ProjectViewMain3.png";

const HomeMain = () => {
  const images = [img1, img2, img3]; // array of banner images
