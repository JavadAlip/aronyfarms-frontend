...
//     image: layerMain3,
//     description1: "Arony Sandalwood Farm offers investors a rare opportunity to own and profit from managed coffee cultivation in India's most sought-after agro-forestry corridor.",
//     description2: 'Our expert team ensures 100% hassle-free, ecologically resilient plantation management and transparent reporting from the day you invest to the day of harvest.'
//   },
//   {
//     title: 'Arony Mango Farm',
//     image: layerMain2,
//     description1: "Arony Mango Farm offers investors a rare opportunity to own and profit from managed coffee cultivation in India's most sought-after agro-forestry corridor.",
//     description2: 'Our expert team ensures 100% hassle-free, ecologically resilient plantation management and transparent reporting from the day you invest to the day of harvest.'
//   },
// ];
...
const AboutUs1 = () => {
    ...
    const projects = [
        ...
        },
        {
            ...
            image: layerMain3,
            description1:
                "Arony Sandalwood Farm offers investors a rare opportunity to own and profit from managed coffee cultivation in India's most sought-after agro-forestry corridor.",
            description2:
                "Our expert team ensures 100% hassle-free, ecologically resilient plantation management and transparent reporting from the day you invest to the day of harvest.",
        },
        {
            ...
            image: layerMain2,
            description1:
                "Arony Mango Farm offers investors a rare opportunity to own and profit from managed coffee cultivation in India's most sought-after agro-forestry corridor.",
            description2:
                "Our expert team ensures 100% hassle-free, ecologically resilient plantation management and transparent reporting from the day you invest to the day of harvest.",
        },
    ];
    ...
    const stats = [
        {
            icon: leafsgrn, // updated image icon
            value: "98%",
            label: "Client satisfaction rate",
            description:
    ...
    // Scroll-based animation with smoother transitions
    const { scrollYProgress } = useScroll({
        target: containerRef,
        offset: ["start start", "end end"],
    });

    // Map scroll progress to current project index with longer range for smoother transitions
                    ...
                    <div className="sticky top-0 h-screen flex items-center justify-center">
                        <div className="relative w-full h-[400px] sm:h-[300px] lg:h-[500px]">
                            {projects.map((project, i) => {
                                // Smoother, wider opacity transitions
