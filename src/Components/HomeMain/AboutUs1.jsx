            ...
            <div className="max-w-7xl mx-auto space-y-10">
                ...
                <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
                    {stats.map((stat, index) => (
                        <div
                            key={index}
                            className="bg-white rounded-2xl p-5 lg:p-6 hover:shadow-md transition-shadow"
                        >
                ...
                <div
                    ref={containerRef}
                    className="relative flex justify-center pt-20 sm:pt-16 lg:pt-24"
                    style={{ minHeight: '600px', perspective: '1000px' }}
                >

                    <div className="relative w-full max-w-6xl" style={{ height: '550px' }}>
                        {projects.map((project, index) => (
                            ...
                            >
                                <div className="relative w-full">
                                    ...
                                    >
                                        {/* Project image */}
                                        <div className="relative h-72 sm:h-[400px] lg:h-[460px] overflow-hidden">
                                            <img
                                                src={layerMain}
                                                alt={project.title}
                                                className="w-full h-full object-cover"
                                            ...
                                            <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent">
                                                ...
                                                {/* Text and button */}
                                                <div className="absolute bottom-5 lg:bottom-16 left-4 right-4 text-white z-20 transition-all duration-300">
                                                    <div className="max-w-[50%] space-y-3">
                                                        <h2 className="text-[24px] sm:text-[34px] md:text-[42px] font-semibold leading-snug">
                                                            {project.title}
                                                        </h2>
                                                        <p className="text-[14px] sm:text-[16px] md:text-[18px] text-white leading-relaxed line-clamp-3">
                                                            {project.description1}
                                                        </p>
                                                        <p className="text-[14px] sm:text-[16px] md:text-[18px] text-white leading-relaxed line-clamp-3">
                                                            {project.description2}
                                                        </p>
                                                        <button className="bg-[#4BA625] hover:bg-green-700 text-white font-medium px-4 py-2 rounded-full inline-flex items-center gap-2 transition-colors mt-2">
                                                            <img
                                                                src={leaf}
                                                                alt="Leaf icon"
                                                                className="w-4 h-4 object-contain"
                                                            />
                                                            <span className="text-[14px] font-medium">View Project Details</span>
                                                        </button>
                                                    </div>
                                                </div>
