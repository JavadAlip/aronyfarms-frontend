...
import React, { useState, useRef } from 'react';
import { X, Eye, ChevronLeft, ChevronRight } from 'lucide-react';
import leafgrn from "../../assets/leaf-grn.png"; // ✅ this stays, since it's inside src/assets
...
const Gallery = () => {
    ...
    // ✅ Use direct public URLs (no import)
    const galleryImages = [
        { id: 1, src: "/assets/Gallerys/coffee2.jpg", alt: "Mountain landscape with farm", size: "small" },
        { id: 2, src: "/assets/Gallerys/coffee1.jpg", alt: "Green leafy vegetables", size: "large" },
        { id: 3, src: "/assets/Gallerys/coffee3.jpg", alt: "Agricultural farm rows", size: "small" },
        { id: 4, src: "/assets/Gallerys/coffee4.jpg", alt: "Rice paddy fields", size: "large" },
        { id: 5, src: "/assets/Gallerys/coffee5.jpg", alt: "Forest plantation", size: "small" },
        { id: 6, src: "/assets/Gallerys/coffee6.jpg", alt: "Forest plantation", size: "large" },
        { id: 7, src: "/assets/Gallerys/coffee7.jpg", alt: "Forest plantation", size: "small" },
        { id: 8, src: "/assets/Gallerys/coffee8.jpg", alt: "Forest plantation", size: "large" },
        { id: 9, src: "/assets/Gallerys/coffee9.jpg", alt: "Forest plantation", size: "small" },
        { id: 10, src: "/assets/Gallerys/coffee10.jpg", alt: "Forest plantation", size: "large" },
    ];
