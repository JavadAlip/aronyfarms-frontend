        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3 mb-6">
            <li className="flex items-start gap-3">
              ...
              <span className="text-[#585858]">Higher yields with fewer inputs</span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 bg-gray-400 rounded-full mt-2 flex-shrink-0"></div>
              <span className="text-[#585858]">More efficient water and pesticide use</span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 bg-gray-400 rounded-full mt-2 flex-shrink-0"></div>
              <span className="text-[#585858]">Sustainable climate-smart farming</span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 bg-gray-400 rounded-full mt-2 flex-shrink-0"></div>
              <span className="text-[#585858]">Increased profitability for farmers</span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-2 h-2 bg-gray-400 rounded-full mt-2 flex-shrink-0"></div>
              <span className="text-[#585858]">Protection of ecosystems and natural land</span>
            </li>
          </ul>
