...
//                         <h2 className="text-[50px] sm:text-4xl lg:text-[50px] font-medium text-gray-900 leading-snug sm:leading-tight lg:leading-[1.2] mb-6">
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 mb-16">
                    ...
                    <div className="flex flex-col justify-center mt-8 sm:mt-12 lg:mt-24 text-center sm:text-left">
                        ...
                        <h2 className="text-[28px] sm:text-4xl lg:text-[50px] font-medium text-gray-900 leading-snug sm:leading-tight lg:leading-[1.2] mb-4 sm:mb-6">
                            <span className="block">Discover Premium Managed</span>
                            <span className="block">Farmland Projects by</span>
                            <span className="block">Arony Farms</span>
                        </h2>
