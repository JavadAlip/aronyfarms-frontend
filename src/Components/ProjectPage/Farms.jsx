  ...
  const farms = [
    {
      ...
      description: "Arony Sandalwood Farm offers investors a rare opportunity to own and profit from managed sandalwood cultivation in India's most sought-after agroforestry corridor.",
      additionalInfo: "Our expert team ensures 100% hassle-free, ecologically resilient plantation management and transparent reporting from the day you invest to the day of harvest.",
      features: [
    ...
    },
    {
      ...
      image: mangofarm,
      description: "Arony Mango Farm offers investors a rare opportunity to own and profit from managed mango cultivation in India's most sought-after agroforestry corridor.",
      additionalInfo: "Our expert team ensures 100% hassle-free, ecologically resilient plantation management and transparent reporting from the day you invest to the day of harvest.",
      features: [
    ...
    },
    {
      ...
      image: coffeefarm,
      description: "Arony Coffee Farm offers investors a rare opportunity to own and profit from managed coffee cultivation in India's most sought-after agroforestry corridor.",
      additionalInfo: "Our expert team ensures 100% hassle-free, ecologically resilient plantation management and transparent reporting from the day you invest to the day of harvest.",
      features: [
        ...
        {farms.map((farm) => (
          <div key={farm.id} className="bg-white rounded-lg overflow-hidden">
              ...
              <div className="flex flex-col lg:flex-row lg:justify-between gap-8">
                ...
                <div className="lg:w-[30%] space-y-3">
                  ...
                  <div className="bg-[#FFF6EC] rounded-lg p-4 border border-orange-100 flex flex-col items-start text-start">
                    ...
                    <p className="text-sm sm:text-base text-[#585858]">{farm.stats.location}</p>
                  </div>
                  ...
                  <div className="bg-[#FFF6EC] rounded-lg p-4 border border-orange-100 flex flex-col items-start text-start">
                    ...
                    <p className="text-sm sm:text-base text-[#585858]">{farm.stats.acresLocation}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="px-4 sm:px-8 lg:px-12 pt-6 pb-8">
              <button className="flex text-sm sm:text-base items-center gap-2 bg-[#4BA625] hover:bg-green-800 text-white px-5 sm:px-6 py-3 rounded-full transition-colors font-medium">
